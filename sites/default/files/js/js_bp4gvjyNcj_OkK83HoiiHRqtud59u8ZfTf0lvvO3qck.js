...
$('#edit-shipping-information-recalculate-shipping').on('click', function(){
  alert('Another Click');
});
document.getElementById("edit-shipping-information-recalculate-shipping").onclick = function() {
  alert('CLICKED');
};;
/**
* DO NOT EDIT THIS FILE.
