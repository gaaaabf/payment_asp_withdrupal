...
class __TwigTemplate_3f363aa7ef65c56eb05853c35cdb3de68082a9b6621801e279437a445ec9107d extends \Twig\Template
{
...
{% macro menu_links(items, attributes, menu_level) %}
  ...
  {% if items %}
    ...
    {% for item in items %}
      ...
      {% if menu_level == 0 and item.is_expanded %}
        ...
        <a href=\"{{ item.url }}\" data-toggle=\"dropdown\">{{ item.title }}</a>
      {% else %}
        <li{{ item.attributes.addClass(classes) }}>
  ...
  {% endif %}
{% endmacro %}
", "themes/bootstrap_mint/templates/navigation/menu--main.html.twig", "/home/acretweb/acret-ph.com/public_html/multty/themes/bootstrap_mint/templates/navigation/menu--main.html.twig");
    }
}
