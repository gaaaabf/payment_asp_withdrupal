    ...
    */
    ...
    private function filterRequest(CleantalkRequest &$request) {
        ...
        foreach ($request as $param => $value) {
            ...
            if (in_array($param, array('message', 'example', 'agent', 'sender_info', 'sender_nickname', 'post_info', 'phone')) && !empty($value)) {
    ...
    private function httpRequest($msg) {
        ...
        $si = \Drupal\Component\Serialization\Json::decode($msg->sender_info);
        ...
        $msg->sender_info = \Drupal\Component\Serialization\Json::encode($si);
